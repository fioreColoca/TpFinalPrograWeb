...
class RegistroModel
{
    ...
    public function enviarMail($email, $usuario){
        ...
        $mail = new PHPMailer(true);
            ...
            $mail->Password = 'transaffnuevo';                               // SMTP password
            ...
            $mail->Body = 'Por favor ingrese al siguiente link para poder verificar su cuenta <a href="http://localhost/activar?usuario='.$usuario.'">aqui</a>';
